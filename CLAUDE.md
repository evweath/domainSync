...
- **Search layer:** `backend/search/engine.py` — `multi_engine_search`, `find_suppliers`, `_google_shopping_search`
- **Competitor search:** `backend/competitor/` — `product_search.py`, `web_search_scan.py`
